...
{
//    drawSqure();
//    drawSqure(255,0,0,255);
//    drawSqure(0.5f, 0.0f, 255,255,0,255);
//    drawRectangle(0.5f, 0.0f, 1.0f, 1.0f, 255, 0, 0, 255);
    for(int i=0; i<5; i++) {
        for(int j=0; j<5; j++) {
            int brightness = (i+j) % 2 * 255;
            drawRectangle((float)i * 0.4f - 0.8f, (float)j * 0.4f - 0.8f,
